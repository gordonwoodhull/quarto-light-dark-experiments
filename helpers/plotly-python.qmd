...
```{python}
from plotly_helpers import plotly_theme_brand
import plotly.io as pio
pio.templates['united_brand'] = plotly_theme_brand('../united-brand.yml')
pio.templates['slate_brand'] = plotly_theme_brand('../slate-brand.yml')
```
